...
@router.get("/{carrera_id}", response_model=GenericResponse)
...
@router.put("/{carrera_id}", response_model=GenericResponse)
...
@router.delete("/{carrera_id}", response_model=GenericResponse)
